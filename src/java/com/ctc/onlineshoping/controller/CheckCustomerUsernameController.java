...
public class CheckCustomerUsernameController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!rs.next()) {
                out.println("<font color=green>Username "+uname+" is Available</font>");
            }
            else{
            out.println("<font color=red>Username "+uname+" is Not Available</font>");
            }
            out.println();
