...
import com.ctc.onlineshoping.dao.MerchantDetailsDAO;
 ...
 * @author Gulshan
 */
@WebServlet(name = "MerchantDetailController", urlPatterns = {"/MerchantDetailController"})
public class MerchantDetailController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            detail.setName(request.getParameter("ownername"));
            ...
            status = dao.saveMerchantDetails(detail);
