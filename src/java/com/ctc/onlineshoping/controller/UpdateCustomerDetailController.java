 ...
 * @author Gulshan
 */
@WebServlet(name = "UpdateCustomerDetailController", urlPatterns = {"/UpdateCustomerDetailController"})
public class UpdateCustomerDetailController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response);
            ...
            UpdateCustomerDetailDAO dao = new UpdateCustomerDetailDAO();
            ...
            if(status){
                ...
                response.sendRedirect("updatecustomerdetails.jsp?error=msg");
