...
public class PaymentController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean status = manage.deductFromAccount((String)session.getAttribute("username"), customerid, amount);
        
        if(status){
             
            response.sendRedirect("merchantaccount.jsp?done=msg");
            
        }
        else{
            response.sendRedirect("merchantaccount.jsp?error=msg");
        }
