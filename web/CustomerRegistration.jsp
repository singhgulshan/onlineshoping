<%-- 
    ...
    Created on : Mar 18, 2016, 1:45:30 PM
    Author     : Gulshan
--%>
...
<html>
 ...
 <script src="jquery.js" type="text/javascript"></script>
    ...
    <body>
        <form action="CustomerDetailController" method="post" onsubmit="return checkPassword()" >
	...
	<td>Customer's Name</td>
        <td><input class="textbox" placeholder="Enter Your Full Name" type="text" name="name"></td>
             </tr>
