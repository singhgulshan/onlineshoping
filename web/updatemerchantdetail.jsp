<%-- 
    Document   : updatemerchantdetail
    Created on : May 10, 2016, 5:10:57 PM
    Author     : Gulshan
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            body {
              ...
              border-radius: 3px;
              overflow: hidden;
              background: #fafafa url("images/arrow.png") no-repeat 96% 0;
                }
    ...
    %>
        ...
        %>
        <form action="UpdateMerchantDetailController" method="post">
            <div class="center">
            <table>
                <tr>
                    <td>Name</td>
                ...
                <tr>
                    <td>Shop Name</td>
                    <td><input type="text" class="textbox" name="shopname" value="<%= detail.getShopname() %>"></td>
                </tr>
                <tr>
                    <td>Line 1</td>
